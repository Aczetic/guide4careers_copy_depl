...
.mailIcon {
 ...
 `
  ...
  return (
    ...
    <div>
      ...
      <div className="flex items-center justify-center gap-4 bg-[#FFFFFF99] md:w-[600px] h-[50px] px-10 rounded-[10px]">
 ...
 <img
    ...
    alt="Stream Image" className="h-8 w-8" />
  <input type="email" placeholder="Enter your Email" className="flex-grow text-sm p-4" />
 </div>
  <button
    type="submit"
    className="bg-blue-700 justify-center items-center text-white border shadow-xl border-transparent rounded-md py-2 px-4 text-sm font-medium hover:bg-indigo-500 hover:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
  >
    REGISTER
  </button>
</div>
