...
const WorkingSteps = () => {
  ...
  const lineAnimation = {
    width: `${Math.min(100, (scrollY-400) / 7)}%` // Adjusted to complete faster
  };
    ...
    <div className='my-32'>
      <div className="timeline">
        ...
        {steps.map((step, index) => (
         <div className="step" key={step.id} style={{ opacity: Math.min(1, (scrollY-400) / 150 - index * 1) }}>             <div className={`vertical-line ${step.position}`}></div>
