    ...
    <div className="px-10 py-4 mx-auto">
      <div className="text-center mb-20">
        <h1 className="sm:text-3xl text-2xl font-bold title-font text-gray-900 mb-4">
         {explore?'Frequently Asked Questions For 11th and 12th class':'Frequently Asked Questions'}
        </h1>
      </div>
  
      <div className="flex flex-wrap justify-center lg:justify-start lg:ml-28">
        <div className="flex flex-col lg:flex-wrap w-full lg:w-1/2">
          {faqData.map((item, index) => (
            <div key={item.id} className="p-2 w-full lg:w-[500px] flex-shrink-0">
              <div
                className="bg-gradient-to-r from-violet-300 to-violet-200 rounded-lg p-6 flex flex-col"
                style={{
                  backgroundColor: expandedItem === item.id ? "#e6d3f7" : "#d3adf7",
                }}
              >
                <div
